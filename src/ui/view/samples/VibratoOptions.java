...
public class VibratoOptions extends JPanel {
    ...
    // constructor
    public VibratoOptions(int modType) {
    ...
    private void init() {
        ...
        vibDepthLabel = new JLabel("Vibrato depth: ");
        ...
        vibDelayLabel = new JLabel("Vibrato delay: ");
        ...
        if (modType == 6) {
            ...
            choices = STR_VIBRATO_WAVEFORMS;
        } else {
            
            choices = XM_IT_VIBRATO_WAVEFORMS;
        }
        
        // set label
        vibWaveformLabel = new JLabel("Vibrato waveform");
