...
public class SampleCanvas extends JPanel {
    ...
    private void setPaths() {
        ...
        if (leftValues.length <= getWidth()) {
            ...
            double samplesPerPixel = leftValues.length / getWidth();
            ...
            for (int i = 0; i < getWidth(); i++) {
                ...
                double highestLPoint = 0, lowestLPoint = 0, highestRPoint = 0,
                        lowestRPoint = 0;
                ...
                if (i == 0) {
                    if (stereo) {
                        ...
                        leftSoundPath.moveTo(lowestLXPoint, lowestLYPoint
                                * halfHeightMultiplier);

                        leftSoundPath.moveTo(lowestLXPoint, 0.5
                                * halfHeightMultiplier);
                        ...
                        rightSoundPath.moveTo(lowestRXPoint, lowestRYPoint
                                * halfHeightMultiplier + rightSampleOffset);

                        rightSoundPath.moveTo(lowestRXPoint, 0.5
                                * halfHeightMultiplier + rightSampleOffset);
                    } else {
                    ...
                    if (stereo) {
                        ...
                        leftSoundPath.lineTo(i,
                                0.5 * halfHeightMultiplier);

                        // right highest lowest and middle
                        rightSoundPath.lineTo(i, highestRYPoint
                                * halfHeightMultiplier + rightSampleOffset);

                        rightSoundPath.lineTo(i, lowestRYPoint
                                * halfHeightMultiplier + rightSampleOffset);

                        rightSoundPath.lineTo(i, 0.5 * halfHeightMultiplier
                                + rightSampleOffset);
                    } else {
    ...
    private void setLeftPoints() {
        ...
        for (int i = 0; i < leftValues.length; i++) {
            ...
            leftYPoints[i] = Math.abs((leftValues[i] / 2 - 0.5));
        }
    }
    ...
    private void setRightPoints() {
        ...
        for (int i = 0; i < rightValues.length; i++) {
            ...
            rightYPoints[i] = Math.abs((rightValues[i] / 2 - 0.5));
        }
    }
